            ...
            <div class="card-body">
              <div class="card-title d-flex justify-content-between align-items-center">
                ...
                <span class="text-danger">
                  @if($shipment->status->name == 'approved')
    				        <a href="{{ route('duties.move_status', ['shipment_id' => $shipment->id]) }}" class="btn btn-primary btn-lg">Accept</a>
                  @elseif($shipment->status->name == 'transit')
                    <a href="{{ route('duties.move_status', ['shipment_id' => $shipment->id]) }}" class="btn btn-primary btn-lg">Delivered</a>
                  @else
                    <p>Delivered</p>
                  @endif
                </span>
